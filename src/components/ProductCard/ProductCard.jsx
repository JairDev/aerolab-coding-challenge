...
function ProductCard({ id, imgSrc, productName, productCategory, productCost }) {
    ...
    <div className="product-card">
      ...
      <div className="product-card-footer">
        ...
        <div className="product-card-action">
          <form action="">
            <button onClick={handleClick} value="20000" data-idproduct={id} className="button-redeem">
